<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoStudent.aspx.cs" Inherits="SOE.html.executive.CoStudent" %>
...
<form id="form1" runat="server">
    ...
    <div id="hac" class="hac">
      ...
      <div class="conterPerfil__cont">
             ...
             <div class="datosPerfil">
                 <div class="datos__personales">
                       <h1 class="datos__title "> Id Estudiante </h1>
                     <div class="datos__user">
                     <asp:Label ID="Label12" runat="server" Text=""></asp:Label>  
                     </div>
                       <h1 class="datos__title "> Fecha de nacimiento </h1>
                     <div class="datos__user">
                     <asp:Label ID="Label11" runat="server" Text=""></asp:Label>  
                     </div>
                     <h1 class="datos__title "> Lugar de nacimiento </h1>
                     <div class="datos__user">
