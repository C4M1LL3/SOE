<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="note.aspx.cs" Inherits="SOE.html.executive.note" %>
        ...
        <div class="userss">
            <div class="userss__cont">
                <div class="userss__buton">
                    <a href="AgNotaTrim.aspx" class="userss__link"> Registrar notas</a>
                </div>
                <div class="userss__buton">
                    <a href="notetrim.aspx" class="userss__link"> Consultar notas</a>
                </div>
                <div class="userss__buton">
                    <a href="AgNotaAnual.aspx" class="userss__link"> Registrar nota anual</a>
                </div>
                <div class="userss__buton">
