<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoSecretary.aspx.cs" Inherits="SOE.html.executive.CoSecretary" %>
...
<form id="form1" runat="server">
    ...
    <div id="hac" class="hac">
      ...
      <div class="conterPerfil__cont">
             ...
             <div class="datosPerfil">
                 <div class="datos__personales">
                       <h1 class="datos__title "> Id secretario </h1>
                     <div class="datos__user">
                     <asp:Label ID="Label12" runat="server" Text=""></asp:Label>  
                     </div>
                       <h1 class="datos__title "> Nombre de la jornada </h1>
                     <div class="datos__user">
