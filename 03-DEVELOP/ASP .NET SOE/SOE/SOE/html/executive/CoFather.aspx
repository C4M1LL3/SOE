<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoFather.aspx.cs" Inherits="SOE.html.executive.CoFather" %>
  ...
  <body>
    ...
    <form id="form2" runat="server">
      ...
      <div class="conterPerfil__cont">
             ...
             <div class="datosPerfil">
                 <div class="datos__personales">
                       <h1 class="datos__title "> Id Padre </h1>
                     <div class="datos__user">
                     <asp:Label ID="Label12" runat="server" Text=""></asp:Label>  
                     </div>
                       <h1 class="datos__title "> Direccion de recidencia del padre </h1>
                     <div class="datos__user">
                     <asp:Label ID="Label11" runat="server" Text=""></asp:Label>  
                     </div>
                     <h1 class="datos__title "> Número de documento del padre </h1>
                     <div class="datos__user">
