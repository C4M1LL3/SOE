<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoEnrollmentt.aspx.cs"
Inherits="SOE.html.executive.CoEnrollmentt" %>
      ...
      <div id="sidebar" class="sidebar">
        ...
        <nav class="nav">
          <ul class="nav__ul">
            ...
            <li class="nav__li">
              <a href="matyasge.aspx" class="nav__link">
            ...
            <li class="nav__li">
              <a href="enrollment.aspx" class="nav__link"> Matriculas </a>
            </li>
            <li class="nav__li">
              <a href="note.aspx" class="nav__link"> Notas </a>
            </li>
            <li class="nav__li">
              <a href="timetable.aspx" class="nav__link"> Horario </a>
            </li>
            <li class="nav__li">
              <a href="student_history.aspx" class="nav__link"> Observador </a>
            </li>
          </ul>
        </nav>
      </div>
        ...
        <div class="conterPerfil">
          ...
          <div class="enrollment__cont">
            ...
            <div class="enrollment__main">
              ...
              <div class="enrollment__campt">
                <p class="enrollment__title">Nombre eps:</p>
                <div class="enr__cont">
                  <asp:Label
                    ID="Label19"
                    runat="server"
              ...
              <div class="enrollment__campt">
                <p class="enrollment__title">Dirección:</p>
                <div class="enr__cont">
                  <asp:Label
                    ID="Label20"
                    runat="server"
              ...
              <div class="enrollment__campt">
                <p class="enrollment__title">Número contacto de la casa:</p>
                <div class="enr__cont">
                  <asp:Label
                    ID="Label21"
                    runat="server"
              ...
              <div class="enrollment__campt">
                <p class="enrollment__title">Estado:</p>
                <div class="enr__cont">
                  <asp:Label
                    ID="Label22"
                    runat="server"
          ...
          <div class="enrollment__cont">
            <div class="enrollment__header">
              <div>
                <asp:Label
                  ID="Label23"
                  runat="server"
                  Text="Datos del padre del estudiante"
                  CssClass="name__profile"
                ></asp:Label>
              </div>
            </div>
            <div class="enrollment__main">
              <div class="enrollment__campt">
                <p class="enrollment__title">Nombre:</p>
                <div class="enr__cont">
                  <asp:Label
                    ID="Label24"
                    runat="server"
              ...
              <div class="enrollment__campt">
                <p class="enrollment__title">Número de contacto:</p>
                <div class="enr__cont">
                  <asp:Label
                    ID="Label30"
                    runat="server"
              ...
              <div class="enrollment__campt">
                <p class="enrollment__title">Dirreción de residencia:</p>
                <div class="enr__cont">
                  <asp:Label
                    ID="Label31"
                    runat="server"
            ...
            <div class="enrollment__header">
              <div>
                <asp:Label
                  ID="Label32"
                  runat="server"
                  Text="Datos de la madre del estudiante"
                  CssClass="name__profile"
                ></asp:Label>
              </div>
            </div>
            ...
            <div class="enrollment__header">
              <div>
                <asp:Label
                  ID="Label41"
                  runat="server"
                  Text="Datos del tutor del estudiante"
                  CssClass="name__profile"
                ></asp:Label>
              </div>
            </div>
