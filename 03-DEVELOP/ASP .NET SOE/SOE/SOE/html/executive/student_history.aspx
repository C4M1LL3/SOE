<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_history.aspx.cs" Inherits="SOE.html.executive.student_history" %>
        ...
        <div class="userss">
            <div class="userss__cont">
                <div class="userss__buton">
                    <a href="AgStudentHistory.aspx" class="userss__link"> Registrar observador </a>
                </div>
                <div class="userss__buton">
                    <a href="AgAnotation.aspx" class="userss__link"> Registrar anotaciones </a>
                </div>
                <div class="userss__buton">
                    <a href="CoStudentHistory.aspx" class="userss__link"> Consultar observador </a>
                </div>
            </div>
        </div>
    </main>
