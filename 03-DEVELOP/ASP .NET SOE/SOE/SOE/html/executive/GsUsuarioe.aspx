<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GsUsuarioe.aspx.cs" Inherits="SOE.html.executive.GsUsuarioe" %>
      ...
      <div class="conterPerfil">
             ...
             <div class="datosPerfil">
                 <div class="datos__personales">
                        <img src="1019982142 FOTO TAMAÑO 3X4 JAIRO STYP RODRIGUEZ PATIÑO.jpg" alt="" class="imagen__imagen">
                        <button class="cambiar"> Cambiar imagen de perfil </button>
                 </div>
             </div>
             <div class="datosPerfil">
                 <div class="datos__personales">
                     ...
                     <h1 class="datos__title "> Correo </h1>
                     <div class="datos__user">
