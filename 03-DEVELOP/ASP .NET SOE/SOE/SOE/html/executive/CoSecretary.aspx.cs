...
{
    public partial class CoSecretary : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            secretary unSecretary = objGestionDatos.ConsultarSecretary(document_number);

            if (unaPersona != null && unSecretary != null && unTypeDocument != null)
            {
                Label12.Text = unSecretary.Id.ToString();
                ...
                Label11.Text = unSecretary.Name_working_day;
            }
            else
            {
