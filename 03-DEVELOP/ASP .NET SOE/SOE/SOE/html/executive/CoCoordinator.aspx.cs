...
{
    public partial class CoCoordinator : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            coordinator unCoordinator = objGestionDatos.ConsultarCoordinator(document_number);

            if (unaPersona != null && unCoordinator != null && unTypeDocument != null)
            {
                Label12.Text = unCoordinator.Id.ToString();
                ...
                Label11.Text = unCoordinator.Number_cycle.ToString();
            }
            else
            {
