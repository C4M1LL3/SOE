<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoCourse.aspx.cs" Inherits="SOE.html.executive.CoCourse" %>
      ...
      <div class="conterPerfil__cont">
             <div class="datosPerfil">
                 <div class="datos__personales">
                     <h1 class="datos__title "> Curso </h1>
                     <div class="datos__user">
                         <asp:Label ID="Label6" runat="server" Text=""></asp:Label>
                     </div>
                     <h1 class="datos__title "> Año en curso </h1>
                     <div class="datos__user">
             ...
             <div class="datosPerfil">
                 <div class="datos__personales">
                       <h1 class="datos__title "> Id Curso </h1>
                     <div class="datos__user">
                     <asp:Label ID="Label8" runat="server" Text=""></asp:Label>  
                     </div>
                       <h1 class="datos__title "> Ciclo </h1>
                     <div class="datos__user">
                     <asp:Label ID="Label9" runat="server" Text=""></asp:Label>  
                     </div>
                     <h1 class="datos__title "> Nombre director de curso </h1>
                     <div class="datos__user">
