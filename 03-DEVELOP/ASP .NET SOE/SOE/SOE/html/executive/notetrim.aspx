<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="notetrim.aspx.cs" Inherits="SOE.html.executive.notetrim" %>
        ...
        <div class="userss">
            <div class="userss__cont">
                <div class="userss__buton">
                    <a href="CoNoteTrim1.aspx" class="userss__link"> Primer trimestre </a>
                </div>
                <div class="userss__buton">
                    <a href="CoNoteTrim2.aspx" class="userss__link"> Segundo trimestre </a>
                </div>
                <div class="userss__buton">
                    <a href="CoNoteTrim3.aspx" class="userss__link"> Tercer trimestre </a>
                </div>
            </div>
        </div>
    </main>
