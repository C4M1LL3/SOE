...
{
    public partial class CoTutor : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            tutor unTutor = objGestionDatos.ConsultarTutor(document_number);

            if (unaPersona != null && unTutor != null && unTypeDocument != null)
            {
                Label12.Text = unTutor.Id.ToString();
                ...
                Label11.Text = unTutor.Address_tutor;
                Label15.Text = unTutor.Number_tutor.ToString();
            }
            else
            {
