<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="note.aspx.cs" Inherits="SOE.html.students.note" %>
        ...
        <div class="userss">
            <div class="userss__cont">
                <div class="userss__buton">
                    <a href="CoNoteTrim1.aspx" class="userss__link"> Consultar primer trimestre</a>
                </div>
                <div class="userss__buton">
                    <a href="CoNoteTrim2.aspx" class="userss__link"> Consultar Segundo trimestre</a>
                </div>
                <div class="userss__buton">
                    <a href="CoNoteTrim3.aspx" class="userss__link"> Consultar tercer trimestre</a>
                </div>
                <div class="userss__buton">
                    <a href="CoNoteAnual.aspx" class="userss__link"> Consultar nota anual</a>
                </div>
            </div>
        </div>
    </main>
