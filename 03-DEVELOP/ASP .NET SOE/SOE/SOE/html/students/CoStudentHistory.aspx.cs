    ...
    public partial class CoStudentHistory : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["usuariologueado"] != null)
            {
                ...
                if (unaPersona != null && unPerson != null && unUser != null && unTypeDocument != null && unStudent != null && unCourse != null && unPersonn != null)
                {
                ...
                using (SqlConnection sqlcon = new SqlConnection(connectionString))
                {
                    ...
                    sqlda.SelectCommand.Parameters.AddWithValue("@document_number", usuariologueado);
